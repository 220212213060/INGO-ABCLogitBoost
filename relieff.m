...
%   predictor. WEIGHT are attribute weights ranging from -1 to 1 with
%   large（权重是从-1到1）
...
%
%   [IDX,WEIGHT] = RELIEFF(X,Y,K,'PARAM1',val1,'PARAM2',val2,...) specifies
